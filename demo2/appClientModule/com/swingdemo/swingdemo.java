...
public class swingdemo extends JFrame {
	...
	protected void spaceSelected(ActionEvent e, int position) {
	  if (inGame && checkspace(position)) {
		  ...
		  case 1: b.setText("X");
		          playerNumber = 2;
		          gameInfo.setText("O's turn, select a space");
		          break;
		  case 2: b.setText("O");
                  playerNumber = 1;
                  gameInfo.setText("X's turn, select a space");
	...
	private void checkWin() {
	  ...
	  if (!gameOver && (bSpace1.getText() != "") && (bSpace1.getText() == bSpace2.getText()) && (bSpace1.getText() == bSpace3.getText())) {
	    gameOver = true;
	    inGame = false;
	    gameInfo.setText(bSpace1.getText() + " wins the game");
	  }
	  if (!gameOver && (bSpace4.getText() != "")  && (bSpace4.getText() == bSpace5.getText()) && (bSpace4.getText() == bSpace6.getText())) {
		    gameOver = true;
		    inGame = false;
		    gameInfo.setText(bSpace4.getText() + " wins the game");
		  }
	  if (!gameOver && (bSpace7.getText() != "")  && (bSpace7.getText() == bSpace8.getText()) && (bSpace7.getText() == bSpace9.getText())) {
		    gameOver = true;
		    inGame = false;
		    gameInfo.setText(bSpace7.getText() + " wins the game");
		  }
	  if (!gameOver && (bSpace1.getText() != "")  && (bSpace1.getText() == bSpace4.getText()) && (bSpace1.getText() == bSpace7.getText())) {
		    gameOver = true;
		    inGame = false;
		    gameInfo.setText(bSpace1.getText() + " wins the game");
		  }
	  if (!gameOver && (bSpace2.getText() != "")  && (bSpace2.getText() == bSpace5.getText()) && (bSpace2.getText() == bSpace8.getText())) {
		    gameOver = true;
		    inGame = false;
		    gameInfo.setText(bSpace2.getText() + " wins the game");
		  }
	  if (!gameOver && (bSpace3.getText() != "")  && (bSpace3.getText() == bSpace6.getText()) && (bSpace3.getText() == bSpace9.getText())) {
		    gameOver = true;
		    inGame = false;
		    gameInfo.setText(bSpace3.getText() + " wins the game");
		  }
	  if (!gameOver && (bSpace1.getText() != "")  && (bSpace1.getText() == bSpace5.getText()) && (bSpace1.getText() == bSpace9.getText())) {
		    gameOver = true;
		    inGame = false;
		    gameInfo.setText(bSpace1.getText() + " wins the game");
		  }
	  if (!gameOver && (bSpace3.getText() != "")  && (bSpace3.getText() == bSpace5.getText()) && (bSpace3.getText() == bSpace7.getText())) {
		    gameOver = true;
		    inGame = false;
		    gameInfo.setText(bSpace3.getText() + " wins the game");
		  }
